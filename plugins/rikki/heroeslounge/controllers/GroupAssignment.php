...
class GroupAssignment extends Controller
{
    public $implement = [
    ...
    public $requiredPermissions = ['rikki.heroeslounge.groupassignment'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Rikki.Heroeslounge', 'manage-general', 'group-assignment');
    }
